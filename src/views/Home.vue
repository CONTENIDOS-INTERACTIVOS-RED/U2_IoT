        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad sobre protocolos y seguridad en IoT profundiza en la implementación de comunicaciones seguras entre dispositivos conectados, considerando restricciones de recursos. Aborda protocolos como MQTT y CoAP, y técnicas de cifrado (AES, RSA) adaptadas para eficiencia. Se analizan riesgos de seguridad, exposición de datos, impacto de ataques, y estrategias de protección como autenticación, gestión de claves y privacidad diferencial. Se destaca la importancia del diseño seguro desde el desarrollo, ante amenazas complejas y regulaciones estrictas. Esta formación es clave para profesionales que lideran proyectos IoT seguros en contextos industriales y empresariales.
